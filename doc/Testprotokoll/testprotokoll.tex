...
%%%%%%%%%%%%%%%%%%%%%%%%%%%	EINFÜHRUNG
\section{Einführung}
Dieses Dokument dient zur Dokumentation der durchgeführten Tests für das Spiel Galaxytrucker. Die Gliederung des Dokuments wurde so vorgenommen, dass zunächst manuelle Tests und anschließend automatische Tests beschrieben werden. Die manuellen Tests wurden so unterteilt, dass zunächst generelle Funktionen getestet werden, und anschließend die Funktionen komplexerer Situation, wie die eines Kampfes. \\
...
Für die View Klassen unseres Projektes bot es sich eher an, die Funktionsweisen manuell zu testen. 
...
Es wird auf den Upgrade Knopf auf der linken Seite des Shops gedrückt. Es sollten alle Systeme, die das Schiff hat, angezeigt werden.  Der Test war erfolgreich. \\
...
Nachdem ein System geupgradet wurde, sollte ein aktualisierter Preis für das nächste Upgrade angezeigt werden, außer es ist bereits das finale Update erreicht.  Der Test war erfolgreich. \\
\subsubsection{Crew upgrade}
Es wird auf den Upgrade Knopf auf der linken Seite des Shops gedrückt. Es sollten zusätzlich zu den Systemen die Crewmitglieder, die auf dem Schiff sind, angezeigt werden.  Der Test war erfolgreich. \\
Wenn auf ein Crew Mitglied gedrückt wird, sollte das angezeigte Geld abgezogen werden. Ebenfalls sollte für das Crewmitglied ein zufälliger Stat um einen Punkt verbessert werden (zu Überprüfen im Inventar).  Der Test war erfolgreich. \\
